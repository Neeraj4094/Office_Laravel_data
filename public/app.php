                ...
                <li class="">
                    ...
                    <ul class="px-2 space-y-3 pb-2">
                        <li class="pt-2 relative">
                            <div class="flex items-center gap-2 p-1 hover:text-slate-400 hover:bg-black rounded-lg">
                                <a href="../admin_details/admin" class="absolute inset-0 z-10"></a>
