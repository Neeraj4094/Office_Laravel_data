  ...
  <script src="https://cdn.tailwindcss.com"></script>
    ...
    {{-- @if(request()->session()->has('user'))
      <h2 class="fixed py-2 font-bold w-full text-center z-30 bg-green-200">
        {{$loggedin_data = print_r(request()->session()->get('user'))}}
      </h2>
    @endif --}}
                ...
                <div class="flex items-center justify-between ">
                    ...
                    <a href="user_form"
                        class=" uppercase px-4 py-2 bg-blue-600 text-white rounded-lg"><span
                            class="font-bold text-xl">+</span> Add User</a>
                </div>
            </div>
            <div class="px-2 border-t">
                <div class="px-2 h-auto space-y-3 overflow-y-scroll">
                    @foreach ($data as $columns => $user_data)
                    <?php 
                            ...
                            <div class=" flex justify-between items-center p-2 gap-4 w-full ">
                                ...
                                <div class="flex items-center justify-between gap-6">
                                    <p class=" bg-purple-500 text-white px-3 py-1 rounded-full">
                                        <?php echo "Position :-" .  $gender ?>
                                    </p>
                                    <form action="{{route('user.update', ['id' => $user_data['id']])}}" method="post" id="update">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="grid place-items-center gap-4 pb-2">
                                                    ...
                                                    <form action="{{route('user.delete', ['id' => $user_data['id']])}}" method="post"
                                                        class="">
                                                        <button type="submit"
